...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("polyuria", "Polyuria (Excessive Urination)", choices = c("No" = 0, "Yes" = 1)),
      selectInput("polydipsia", "Polydipsia (Extreme Thirst)", choices = c("No" = 0, "Yes" = 1)),
      selectInput("sudden_weight_loss", "Sudden Weight Loss", choices = c("No" = 0, "Yes" = 1)),
      selectInput("polyphagia", "Polyphagia (Excessive Hunger)", choices = c("No" = 0, "Yes" = 1)),
      selectInput("irritability", "Irritability (Feeling more irritable/sensitive than usual)", choices = c("No" = 0, "Yes" = 1)),
      selectInput("partial_paresis", "Partial Paresis (Decrease in strength/control in specific muscles)", choices = c("No" = 0, "Yes" = 1)),
